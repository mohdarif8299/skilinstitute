    ...
    protected void onCreate(Bundle savedInstanceState) {
            ...
            public boolean onItemSelect(int i) {
                ...
                switch (i) {
                    ...
                    case 4:
                        ...
                        //Toast.makeText(getApplicationContext(),counter+"INC",Toast.LENGTH_LONG).show();
                        break;
                }
                return false;
            }
        ...
        bottomBar.setOnItemReselectedListener(new OnItemReselectedListener() {
            ...
            public void onItemReselect(int i) {
                ...
                if (i == 4) {
                    counter++;
                    //Toast.makeText(getApplicationContext(),counter+"<-INC-> "+i,Toast.LENGTH_LONG).show();

                    if (counter == 30) {
                        //togglerStatus(!tst);
                        userSession.setStatus("true");
                        //Toast.makeText(getApplicationContext(),"Congo your oayment is approved",Toast.LENGTH_LONG).show();
